...
public class ReturnNodesUnitTests {
  ...
  public void retrieveNodeByColor() {
    ...
    nodesList.add(new Nodes(new Motherboard("Intel")));
    nodesList.add(new Nodes(new Motherboard("Sony")));
    nodesList.add(new Nodes(new Motherboard("AMD")));
  ...
  public void findMotherBoard() throws JsonProcessingException {
    station.addSingleNode(new Nodes(new Motherboard("Intel")));
    station.addSingleNode(new Nodes(new Motherboard("ASUS")));
